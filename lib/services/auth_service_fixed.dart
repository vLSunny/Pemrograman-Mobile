...
class AuthService {
  ...
  static Future<bool> isLoggedIn() async {
    final userId = await PlatformStorageService.getSecureData(_userIdKey);
    return userId != null && userId.isNotEmpty;
  }

  // Get current user ID
  static Future<String?> getCurrentUserId() async {
    return await PlatformStorageService.getSecureData(_userIdKey);
  }

  // Set current user ID
  static Future<void> setCurrentUserId(String userId) async {
    await PlatformStorageService.saveSecureData(_userIdKey, userId);
    await PlatformStorageService.saveSecureData(_isFirstTimeKey, 'false');
  }

  // Check if it's first time using app
  static Future<bool> isFirstTime() async {
    final isFirst = await PlatformStorageService.getSecureData(_isFirstTimeKey);
  ...
  static Future<void> logout() async {
    await PlatformStorageService.deleteSecureData(_userIdKey);
  }
